...
const Sidebar = () => {
  ...
  return (
    <div style={{width: 0, height: 0, position: "relative", zIndex:10000, top:65, left:15}} className='btn-group-vertical'>
