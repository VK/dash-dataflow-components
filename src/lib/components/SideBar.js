...
const button_style = {width: 30, height: 30, padding:2, paddingBottom:4};
const icon_width= 16;
...
const Sidebar = () => {
  ...
  return (
    <div style={{width: 0, height: 0, position: "relative", zIndex:10000, top:115, left:15}} className='btn-group-vertical'>
